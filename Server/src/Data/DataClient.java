...
public class DataClient {
    ...
    private final HashMap<Integer,DataWritter> list = new HashMap<>();
    private PanelStatus status;
    private JTable table;
    
    public void addWrite(DataWritter data, int fileID) {
    ...
    public void closeWritter(int fileID) throws IOException {
    ...
    public DataFileServer getDataFileServer(int fileID) throws IOException {
        DataWritter data = list.get(fileID);
