...
public class Server extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Data", "No", "Name", "Files Sent From Client"
            }
        ) {
    ...
    private void cmdStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdStartActionPerformed
        ...
        //System.out.println("Server button e click krlam"); 
    ...
    private int initFileTransfer(SocketIOClient client, DataInitFile dataInit) {
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            ...
            if (data.getClient() == client) {
                try {
                    id = generateFileID();
                    File file = new File("G:/socket_data/" + id + "-" + dataInit.getFileName());
                    DataWritter writter = new DataWritter(file, dataInit.getFileSize());
                    data.addWrite(writter,id);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            ...
            if (data.getClient() == client) {
                try {
                    ...
                    data.closeWritter(file.getFileID());
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
